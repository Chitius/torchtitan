...
def deepseek_v3_custom_500m() -> Trainer.Config:
    """500M config with MTP=1, bfloat16. Toggle _EP_DEGREE / _NUM_MTP at top of file."""
    base_seq_len = 2048
    return Trainer.Config(
        ...
        parallelism=ParallelismConfig(
            ...
            expert_parallel_degree=_EP_DEGREE,
        ),
...
def deepseek_v3_custom_3b() -> Trainer.Config:
    """3B config with MTP=1, bfloat16. Toggle _EP_DEGREE / _NUM_MTP at top of file."""
    base_seq_len = 4096
    return Trainer.Config(
        loss=_make_loss(),
        hf_assets_path="tests/assets/deepseek_v3",
